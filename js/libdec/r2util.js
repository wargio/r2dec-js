...
export default (function () {
  ...
  var usages = {
    ...
    "--as-comment":
      "the decompiled code is returned to r2 as comment (via CCu)",
    "--as-code-line":
      "the decompiled code is returned to r2 as 'file:line code' (via CL)",
    "--as-json": "the decompiled code lines are returned as JSON",
    "--annotation":
      "the decompiled code lines are returned with the annotation format",
  };
  ...
  function print_issue() {
    ...
    var farguments = r2_sanitize(
      r2pipe.string("afvj", true),
      '{"sp":[],"bp":[],"reg":[]}',
    );
    var arch = r2_sanitize(r2pipe.string("e asm.arch"), "");
    var archbits = r2_sanitize(r2pipe.string("e asm.bits"), "32");
    var database = r2_sanitize(
      r2pipe.custom("afsj @@i", merge_arrays_stringify),
      "[]",
    );
    console.log(
  ...
  var r2util = {
    ...
    evars: function (args) {
      ...
      o.extra = {
        ...
        highlights: r2pipe.bool("e r2dec.highlight") ||
          has_option(args, "--highlight-current"),
      ...
      o.add_comment = function (comment, offset) {
        ...
        radare2.command(
          "CCu base64:" + btoa(comment) + " @ 0x" + offset.toString(16),
        );
      };
      o.add_code_line = function (comment, offset) {
        ...
        var line = __line_cnt++;
        radare2.command(
          '"CL 0x' + offset.toString(16) + " r2dec.c:" + line + " " +
            comment.replace(/\n/g, "; ").replace(/\\/g, "\\\\").replace(
              /"/g,
              '\\"',
            ) + ';"',
    ...
    debug: function (evars, exception) {
      ...
      if (!evars || evars.extra.debug) {
        ...
        return "\n\nr2dec has crashed (info: " + r2pipe.string("i~^file[1:0]") +
          " @ " + r2pipe.string("s") + ").\n" +
