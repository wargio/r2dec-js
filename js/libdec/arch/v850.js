  ...
  instructions: {
    ...
    setf: function (instr, context) {
      ...
      if (e.opd[0] == "v" || e.opd[0] == "nv") {
        var m = new Variable.macro(
          (e.opd[0] == "nv" ? "!" : "") + "IS_OVERFLOW(" + context.cond.a +
            ", " + context.cond.b + ")",
        );
        var op = Base.conditional_assign(e.opd[1], m, null, "CUST", "1", "0");
        Global().context.addMarcro(
          "#define IS_OVERFLOW(a,b) (((a<0)&&(b<0)&&(a+b>0))||((a>0)&&(b>0)&&(a+b<0)))",
        );
        return op;
      }
    ...
    tst: function (instr, context, instructions) {
      var e = instr.parsed;
      context.cond.a = (e.opd[0] == e.opd[1])
        ? e.opd[1]
        : "(" + e.opd[1] + " & " + e.opd[0] + ")";
      context.cond.b = "0";
      return Base.nop();
